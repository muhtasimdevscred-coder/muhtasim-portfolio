  ...
  return (
    <section className="max-w-container mx-auto px-gutter py-xxl grid md:grid-cols-2 items-center gap-12">
      <div className="order-2 md:order-1">
        <h1 className="text-display-lg-mobile md:text-display-lg text-on-surface dark:text-white mb-4">
          Hi, I&apos;m Muhtasim Ahmed, Content Developer &amp;{' '}
          <span className="text-primary dark:text-inverse-primary">Technical Writer.</span>
        </h1>
        <p className="text-body-lg text-on-surface-variant dark:text-gray-300 mb-6 leading-relaxed">
        ...
        <div className="flex flex-wrap gap-4">
          <a
            href="/cv.pdf"
            className="flex items-center gap-2 bg-primary dark:bg-primary-container text-on-primary px-8 py-3.5 rounded-xl text-label-md hover:shadow-xl transition-standard"
          >
          ...
          <a
            href="#portfolio"
            className="flex items-center gap-2 border-2 border-primary dark:border-inverse-primary text-primary dark:text-inverse-primary px-8 py-3.5 rounded-xl text-label-md hover:bg-primary/5 dark:hover:bg-white/5 transition-standard"
          >
            View Portfolio
          </a>
        </div>
